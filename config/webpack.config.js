  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        'store-composers': path.resolve(__dirname, '../src/Store/composers'),
        'store-states': path.resolve(__dirname, '../src/Store/states'),
        'store-definitions': path.resolve(__dirname, '../src/Store/definitions'),       

        // app components
        'Dashboard': path.resolve(__dirname, '../src/Deahboard'),
